...
export default function Coin({ setOpen, seconds }) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <button className="bg-[#0db65e] w-[107.38px] h-[37.33px] rounded-bl-xl rounded-tr-xl">
          Green
        </button>

        <button className="bg-[#9b42dc] w-[107.38px] h-[37.33px] rounded-lg">
          Violet
        </button>

        <button className="bg-[#df3735] w-[107.38px] h-[37.33px] rounded-br-xl rounded-tl-xl">
          Red
        </button>
      ...
      <div className="flex gap-1 mt-3">
        ...
        <button className="border border-red-500 text-red-500 py-1 px-2 rounded-lg mr-1">
          Random
        </button>
